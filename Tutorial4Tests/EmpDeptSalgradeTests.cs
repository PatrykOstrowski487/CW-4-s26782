    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var result = emps
                .SelectMany(
                    ...
                    (emp, grade) => new {EName = emp.EName, Grade = grade.Grade}
                    );
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        ...
        var result = emps
            .Join(emps
                    ...
                    {
                        DeptNo = s.Key,
                        AvgSal = s.Average(e => e.Sal),
                    }),
                emp => emp.DeptNo,
                avg => avg.DeptNo,
                (emp, avg) => new { emp, avg.AvgSal })
            .Where(e => e.emp.Sal > e.AvgSal)
            .Select(e => e.emp.EName)
            .ToList();
